...
public class VideoQueryingValidator {
    public static void main(String[] args) {
        try {
            ...
            // Converting the XML string to a document.
            String candidateCaptionXMLString = XMLUtil.convertToXML(String.valueOf(sb.toString()));
            System.out.println("candidateCaptionXMLString :: " + candidateCaptionXMLString);
            Document candidateDoc = CommonUtil.getInstance().convertStringToDocument(candidateCaptionXMLString);

            List<String> output = XMLUtil.getInstance().executeXPathQuery(candidateDoc,  optimizedXPath);
