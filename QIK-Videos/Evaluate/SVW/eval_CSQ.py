...
# Constants
DATABASE_DIR = "/mydata/SVW_Train_Videos"
QUERY_DIR = "/mydata/SVW_Test_Videos"
GROUND_TRUTH_FILE = "SVW_Ground_Truth.pkl"
...
if __name__ == '__main__':
    ...
    checkpoint = torch.load("video_ep-0100_SVW_64bits.pth", map_location=torch.device('cpu'))
