...
GROUND_TRUTH = "kinetics400_groundtruth.pickle"
...
def get_query_list():
    ...
    for filename in os.listdir(VIDEO_DIR):
        ...
        if filename.endswith(".mp4"):
            query_lst.append(VIDEO_DIR + "/" + filename)
...
if __name__ == '__main__':
    ...
    for query in query_lst:
        ...
        try:
            ...
            with open('qik_ucf101_results.txt', 'a+') as f:
                f.write(query + "=" + str(id_lst[:16]) + "\n")
    ...
    with open('relevance_2_lst.pkl', 'wb') as fp:
        pickle.dump(relevance_2_lst, fp)
    with open('relevance_4_lst.pkl', 'wb') as fp:
        pickle.dump(relevance_4_lst, fp)
    with open('relevance_8_lst.pkl', 'wb') as fp:
        pickle.dump(relevance_8_lst, fp)
    with open('relevance_16_lst.pkl', 'wb') as fp:
