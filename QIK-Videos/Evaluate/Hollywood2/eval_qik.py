...
QUERY_DIR = "/mydata/Hollywood2_Test"
GROUND_TRUTH = "Hollywood2/hollywood2_groundtruth.pickle"
RESULTS_FILE_PREFIX = "Hollywood2/qik_hollywood2_test_set_50_frames_updated_captioning_results"
    ...
    for query in query_lst:
        ...
        try:
            ...
            with open(RESULTS_FILE_PREFIX + ".txt", 'a+') as f:
                f.write(query_name + "=" + str(id_lst) + "\n")

            # Obtaining the ground truth
            ground_truth = groundtruth[query_name]
