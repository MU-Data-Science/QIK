...
path.append("../ShowAndTell/im2txt")
...
def init():
  ...
  if not is_initialized:
    ...
    tf.flags.DEFINE_string("checkpoint_path", "../ShowAndTell/checkpoints/",
                           "Model checkpoint file or directory containing a "
                           "model checkpoint file.")
    tf.flags.DEFINE_string("vocab_file", "../ShowAndTell/checkpoints/word_counts.txt",
