...
public class Constants {
	...
	public static final String NECC_DETAILS_QUERY_STRING = "//DT | //CC | //PRP | //IN";
	public static final String UNIQUE_NECC_DETAILS_QUERY_STRING = "//*[substring(name(), 0,3) = \"DT\"] | //*[substring(name(), 0,3) = \"CC\"] | //*[substring(name(), 0,4) = \"PRP\"] | //*[substring(name(), 0,3) = \"IN\"]";
